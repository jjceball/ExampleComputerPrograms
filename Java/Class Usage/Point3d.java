...
class Point3d extends Point2d
{
	...
	public Point3d()
	{
		...
		// perhaps a better method would be to replace the above code
		// with this (0, 0, 0);
	}
	...
	public Point3d(Point3d pt)
	{
		...
		// perhaps a better method would be to replace the above code
		// with this (pt.getX(), pt.getY(), pt.getZ());
	}
	...
	public static void main(String[] args)
	{
		...
		pt1.setDebug(true); // turn on debugging statements for pt1
		...
		pt1.setDebug(false); // turning off debugging statements for pt1
